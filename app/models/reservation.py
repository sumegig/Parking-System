...
class Reservation(Base):
    ...
    start_time = Column(DateTime(timezon=True), nullable=False)
    end_time = Column(DateTime(timezon=True), nullable=False)
    satus = Column(String(20), nullable=False, default="CONFIRMED")
